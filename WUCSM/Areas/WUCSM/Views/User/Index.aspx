...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 100%; margin-top: 30px;">
        <div id="portaltoolbar" style="border: 1px solid #cccccc; border-bottom: none; margin-top: 10px;
            ...
            &nbsp;&nbsp;&nbsp;用户姓名：<input id="USERNAME" name="USERNAME" class="mini-textbox"
                onenter="onKeyEnter" />
            &nbsp;&nbsp;&nbsp;客户号：<input id="CUSID" name="CUSID" class="mini-textbox" onenter="onKeyEnter" />
           
            <%-- &nbsp;&nbsp;&nbsp;门店号：<input id="CUSORGID" name="CUSORGID" class="mini-textbox" onenter="onKeyEnter" />--%>
            &nbsp;&nbsp;&nbsp;用户类型：<input id="USERTYP" name="USERTYP" class="mini-combobox" style="width: 125px;"
                textfield="text" valuefield="id" emptytext="----不限----" shownullitem="true" nullitemtext="----不限----"
                data="utype" onvaluechanged="RefreshData" value="01" />
            &nbsp;&nbsp;&nbsp;用户状态：<input id="STT" name="STT" class="mini-combobox" style="width: 125px;"
                textfield="text" valuefield="id" emptytext="----不限----" shownullitem="true" nullitemtext="----不限----"
                data="sstt" onvaluechanged="RefreshData" value="1" />
            <br />
            &nbsp;&nbsp;&nbsp;性&nbsp;&nbsp;&nbsp;别：<input id="SEX" name="SEX" class="mini-combobox"
                style="width: 125px;" textfield="text" valuefield="id" emptytext="----不限----" shownullitem="true"
                nullitemtext="----不限----" data="uset" onvaluechanged="RefreshData" />
            &nbsp;&nbsp;&nbsp;超级用户：<input id="ISSYS" name="ISSYS" class="mini-combobox" style="width: 125px;"
                textfield="text" valuefield="id" emptytext="----不限----" shownullitem="true" nullitemtext="----不限----"
                data="uissys" onvaluechanged="RefreshData" />
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 100%;">
                        ...
                        <%-- <a class="mini-button" iconcls="icon-remove" plain="true"  <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","delete") %>  onclick="remove()">删除</a>--%>
                        <a class="mini-button" iconcls="icon-no" plain="true" <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","userno") %>
                            onclick="userno()">用户停用</a> <a class="mini-button" iconcls="icon-user" plain="true"
                                <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","setuser") %> onclick="setuser()">
                                激活账户</a> <a class="mini-button" iconcls="icon-goto" plain="true" <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","setpwd") %>
                                    onclick="setpwd()">重置密码</a> <a class="mini-button" iconcls="icon-unlock" plain="true"
                                        <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","savepwr") %> onclick="setpwr()">
                                        权限授权</a>
                    </td>
                </tr>
            </table>
    ...
    <div id="portalgrid" class="mini-datagrid" idfield="id" url="<%=Url.RouteUrl(new { controller="User",action="GetUsers" ,area="WUCSM"}) %>"
        ...
        <div property="columns">
            ...
            <div type="indexcolumn" style="text-align: center; width: 10px;">
                序号</div>
            <div field="LOGID" width="120" headeralign="center" allowsort="true">
                登录号</div>
            <div field="USERNAME" width="120" allowsort="true" headeralign="center">
                用户姓名</div>
            <div field="CUSID" width="80" allowsort="true" headeralign="center">
                客户号</div>
            ...
            <div field="CUSNAME" width="170" allowsort="true" headeralign="center">
                客户名称</div>
            <div field="USERTYP" width="80" allowsort="true" headeralign="center" align="center"
                renderer="onUserTypRenderer" headeralign="center">
                用户类型</div>
            <div field="STT" width="80" allowsort="true" headeralign="center" align="center"
            ...
            <div field="SEX" width="60" allowsort="true" renderer="onSexRenderer">
                性别</div>
            <div field="ISSYS" width="80" allowsort="true" renderer="onIsSysRenderer">
                超级用户</div>
        </div>
    </div>
        ...
        <div id="editForm1" style="padding: 5px; width: 100%">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Text4" name="USERTYP" class="mini-combobox" data=" [{ 'id': '01', 'text': '系统用户' }, { 'id': '02', 'text': '客户用户'}]"
                            required="true" style="width: 250px" value="02" onvaluechanged="cus();" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100px; text-align: center">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limittype="*.jpg;*.png;*.gif;*.bmp"
                            flashurl="/Scripts/swfupload/swfupload.swf" uploadurl='<%=Url.RouteUrl(new { controller="User",action="UpLoad" ,area="WUCSM"}) %>'
                            onuploadsuccess="onUploadSuccess" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100px; text-align: center;">
                        <span style="color: Red">*</span>客户特征码：
                    </td>
                    <td colspan="2">
                        <input id="cusidandcusorgid" name="cusidandcusorgid" class="mini-textbox" maxlength="16"
                            vtype="int" enabled="false" style="width: 98%" />
                    </td>
                    <td style="text-align: right; padding-top: 5px; padding-right: 3px;" colspan="2">
                        <a class="mini-button" iconcls="icon-save" plain="false" <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","update") %>
                    ...
                    <td style="text-align: left; padding-top: 5px; padding-right: 3px; padding-left: 30px">
                        <a class="mini-button" iconcls="icon-upload" plain="false" <%=new WUCSM.Helpers.HtmlPwrFilter().Handle("USER","upload") %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function RefreshData() {
            ...
            var CUSID = mini.get("CUSID").getValue();
            var CUSORGID = ""; //mini.get("CUSORGID").getValue();
            

            var USERTYP = mini.get("USERTYP").getValue();
            var STT = mini.get("STT").getValue();
            var SEX = mini.get("SEX").getValue();
            var ISSYS = mini.get("ISSYS").getValue();
            mini.get("portalgrid").load({ LOGID: LOGID, USERNAME: USERNAME, CUSID: CUSID, CUSORGID: CUSORGID, USERTYP: USERTYP, STT: STT, SEX: SEX, ISSYS: ISSYS });
        ...
        function updateuserstt() {
            ...
            if (rows.length == 1) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<%=Url.RouteUrl(new { controller="User",action="SetUSER" ,area="WUCSM"}) %>',
        ...
        function remove() {
            ...
            if (rows.length > 0) {
                if (confirm("确定删除选中记录？")) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<%=Url.RouteUrl(new { controller="User",action="DeleteUsers" ,area="WUCSM"}) %>',
                        data: effectRow,
                        success: function (res) {
                            mini.alert("删除成功！");
                            grid.reload();
        ...
        function userno() {
            ...
            if (rows.length > 0) {
                if (confirm("确定停用选中用户？")) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<%=Url.RouteUrl(new { controller="User",action="USERno" ,area="WUCSM"}) %>',
                        data: effectRow,
                        success: function (res) {
                            mini.alert("停用成功！");
                            grid.reload();
        ...
        function setpwd() {
            ...
            if (rows.length > 0) {
                if (confirm("确定重置选中用户密码？")) {
                    ...
                    grid.loading("操作中，请稍后......");
                    $.ajax({
                        url: '<%=Url.RouteUrl(new { controller="User",action="SetPWD" ,area="WUCSM"}) %>',
                        data: effectRow,
                        success: function (res) {
                            mini.alert("密码重置成功！");
                            grid.reload();
        ...
        function setpwr() {
            ...
            if (row) {
                mini.open({
                    url: '<%=Url.RouteUrl(new { controller="User",action="UserPwr" ,area="WUCSM"}) %>',
        ...
        function add() {
            ...
            mini.get("cusidandcusorgid").setEnabled(true);
        ...
        function editRow(row_uid) {
            ...
            if (row) {
                ...
                if (grid.isNewRow(row)) { form.reset(); return; }
                    ...
                    mini.get("cusidandcusorgid").setEnabled(false);
                    form.loading();
                    $.ajax({
                        url: '<%=Url.RouteUrl(new { controller="User",action="GetUsersbyLogID" ,area="WUCSM"}) %>',
        ...
        function SaveSvc() {
            ...
            if (row.length > 0) {
                ...
                $.ajax({
                    url: '<%=Url.RouteUrl(new { controller="User",action="SaveSvc" ,area="WUCSM"}) %>',
                    data: { data: json, cusidandcusorgid: cusidandcusorgid },
                    dataType: 'json',
                    async: false,
                    success: function (res) {
                        if (res.msg == "OK") {
        ...
        function cus() {
            var usertyp = mini.get("Text4").getValue();
            if (usertyp == "01") {
                mini.get("cusidandcusorgid").setEnabled(false);
            } else {
                mini.get("cusidandcusorgid").setEnabled(true);
